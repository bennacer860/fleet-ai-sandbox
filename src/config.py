...
TRADE_SIZE_1440M = float(os.getenv("TRADE_SIZE_1440M", "50.0"))
TRADE_SIZE_STOCKS = float(os.getenv("TRADE_SIZE_STOCKS", "10.0"))
TRADE_SIZE_TEMPERATURE = float(os.getenv("TRADE_SIZE_TEMPERATURE", "10.0"))
POST_EXPIRY_MULTIPLIER = float(os.getenv("POST_EXPIRY_MULTIPLIER", "2.0"))
TEMPERATURE_POST_EXPIRY_PRICE_THRESHOLD = float(
    os.getenv("TEMPERATURE_POST_EXPIRY_PRICE_THRESHOLD", "0.90")
)
CITY_TEMP_EXPIRY_BUFFER_HOURS = float(os.getenv("CITY_TEMP_EXPIRY_BUFFER_HOURS", "0.0"))
